...
const Pricing = () => {
    ...
    const categories = [
        { title: "Ilmiy ishlar", items: services.slice(0, 8) },
        { title: "Qo'shimcha xizmatlar", items: services.slice(8) }
    ];
    ...
    const pricingJsonLd = {
        ...
        "url": "https://ilmiyxizmat.uz/narxlar",
    ...
    return (
        <>
            <SEO
                ...
                description="Ilmiy ishlar yozish narxlari: BMI yozish 500 000 so'mdan, dissertatsiya, ilmiy maqola, kurs ishi. Shaffof narxlar, maxfiy to'lovlar yo'q. Bo'lib to'lash imkoniyati."
